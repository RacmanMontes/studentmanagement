...
<div class="container py-5">
    <div class="mx-auto" style="max-width: 500px;">
        <h2 class="mb-4 text-center text-light">Add Subject</h2>

        <form action="{{ route('subjects.store') }}" method="POST" class="bg-dark p-4 rounded shadow border border-secondary">
            @csrf
